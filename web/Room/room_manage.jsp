...
<center>
    <form action="room_manage.jsp" method="post">
...
<table width="1100px" border="1" align="center" cellpadding="10px">
    ...
    <tr align="center">
        ...
        <td>
            <a href="add_room.jsp">增加</a>|
            <a href="DeleteRoomMessage.jsp?name=<%=rs.getString(1)%>">删除</a>|
            <a href="UpdateRoomMessage.jsp?name=<%=rs.getString(1)%>">修改</a>
        </td>
    </tr>
    <%
                rs.next();
...
<div align="center">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; <a href="room_manage.jsp">|主页|</a>
    <%
        for (int j = 1; j <= intPageCount; j++) {
            out.print("&nbsp;&nbsp;<a href='room_manage.jsp?page=" + j + "'>" + j + "</a>");
        }
    %>
    <center>
        <br/>
