...
<center>
    <table align="center" cellspacing="20px">
        <tr align="center">
            <td align="center">
                <form action="stu_manage.jsp" method="post">
...
<table width="1110px" border="1" align="center" cellpadding="0px" cellspacing="0px">
    ...
    <tr align="center">
        ...
        <table align="center" cellspacing="10px">
            <tr align="center">
                <td align="center">
                        <form action="UpdateStuMessage.jsp" method="post">
                ...
                <td align="center">
                    <form action="DeleteMStuMessage.jsp" method="post">
                        <input type="hidden" name="sno" value="<%=rs.getString(1)%>">
                        <input type="hidden" name="room_num" value="<%=rs.getString(4)%>">
...
<div align="center">
    ...
    <center>
        <table align="center" cellpadding="10px">
            <tr align="center">
                <td align="center">
                    <form action="../ExcelToDbServlet" method="post">
                        <fieldset>
                ...
                <td align="center">
                    <form action="../DbToExcelServlet" method="post">
                        <fieldset>
